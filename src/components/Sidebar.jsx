...
export default function Sidebar() {
    ...
    const menuClass = ({ isActive }) =>
        ...
        ${isActive
            ? "bg-[#7A1F2D]/90 text-white font-semibold shadow-lg backdrop-blur"
    ...
    return (
        ...
        ">
            ...
            {/* GLOW HALUS */}
            <div className="absolute top-0 left-0 w-40 h-40 bg-[#7A1F2D]/10 blur-3xl rounded-full"></div>
                            ...
                            <NavLink to={item.key} className={menuClass}>
                                {({ isActive }) => (
                                    <>
                                        {/* ACTIVE BAR */}
                                        {isActive && (
                                            <div className="absolute left-0 top-2 bottom-2 w-1 bg-[#7A1F2D] rounded-r-full"></div>
                                        )}
            ...
            ">
                ...
                {/* glow kecil */}
                <div className="absolute -top-6 -right-6 w-20 h-20 bg-[#7A1F2D]/20 blur-2xl rounded-full"></div>
                ...
                <button className="
                    w-full bg-[#7A1F2D] text-white font-semibold py-2 
